 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int) = ((sagenes * 3 + arshins) * 16 + vershoks) * 4.445 / 100
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int) = ((deg * 60 + min) * 60 + sec) * PI / (180 * 3600)
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double) = sqrt((x2 - x1).pow(2) + (y2 - y1).pow(2))
